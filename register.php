    ...
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(($_SESSION["rand"] != $captcha) && ($_SESSION["rand"] != "")){
                ...
                $error_message = "<p class='message_error'><strong>Ошибка!</strong>Неправильная капча</p>";
            ...
            if(isset($_POST["password"])){
                ...
                if(isset($_POST["confirm_password"])){
                    ...
                    if($confirm_password != $password){
                        // Сохраняем в сессию сообщение об ошибке. 
                        $_SESSION["error_messages"] .= "<p class='message_error' >Пароли не совпадают</p>";
                    ...
                    // Сохраняем в сессию сообщение об ошибке. 
                    $_SESSION["error_messages"] .= "<p class='message_error' >Отсутствует поле для повторения пароля</p>";
            ...
            if(!$result_query_insert){
                ...
                if(!$query_insert_confirm){
                    ...
                    $message = 'To get started <a href="http://www.bradsitereact.ml/activation.php?email='.$email.'&token='.$token.'">Verify your account</a><br><br>';
                    ...
                    if(mail($email, $subject, $message, $headers)){
                        ...
                        //var_dump(mail($email, $subject, $message, $headers));die();
